          ...
          <div className="flex w-full max-w-6xl bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-2xl overflow-hidden">
            ...
            <div className="w-2/3 p-8">
              ...
              <div className="text-center mb-6 p-6 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md shadow-md dark:shadow-xl transition-transform transform hover:scale-105">
                <h3 className="text-xl font-semibold mb-2 text-[#F97316]">Introduction</h3>
                  <h4 className="font-semibold overflow-hidden">
                    Please provide your personal details to finalize your booking.
                  </h4>
                <p className="text-md text-gray-700 dark:text-gray-300">
                  This information is required to process your reservation accurately and ensure a smooth check-in experience.</p>
              </div>
              ...
              <div className="mb-6 p-6 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md shadow-md dark:shadow-xl transition-transform transform hover:scale-105">
                ...
                <p className="text-md text-gray-700 dark:text-gray-300">
                  <FaHotel className="inline mr-2" /><strong>Hotel Name:</strong> {orderDetails.hotelName}
                </p>
                <p className="text-md text-gray-700 dark:text-gray-300">
                  <strong>Guests:</strong> {orderDetails.guests}
                </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="flex flex-col mb-4">
                  <label htmlFor="firstName" className="text-lg font-medium mb-2 flex items-center">
                  ...
                  <input
                    ...
                    value={formData.firstName}
                    onChange={handleChange}
                    className="border border-gray-300 rounded-lg p-3 w-full focus:outline-none focus:ring-2 focus:ring-[#F97316] transition-shadow"
                    required
                  />
                </div>
                <div className="flex flex-col mb-4">
                  <label htmlFor="lastName" className="text-lg font-medium mb-2 flex items-center">
                ...
                <div className="flex flex-col mb-4">
                  <label htmlFor="email" className="text-lg font-medium mb-2 flex items-center">
                ...
                <div className="flex flex-col mb-4">
                  <label htmlFor="phone" className="text-lg font-medium mb-2 flex items-center">
                ...
                <div className="flex flex-col mb-4">
                  <label htmlFor="checkInDate" className="text-lg font-medium mb-2 flex items-center">
                ...
                <div className="flex flex-col mb-6">
                  <label htmlFor="checkOutDate" className="text-lg font-medium mb-2 flex items-center">
